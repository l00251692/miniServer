CREATE TABLE IF NOT EXISTS zipkin_spans (
  ...
  UNIQUE KEY(`trace_id_high`, `trace_id`, `id`) COMMENT 'ignore insert on duplicate',
  INDEX(`trace_id_high`, `trace_id`, `id`) COMMENT 'for joining with zipkin_annotations',
...
CREATE TABLE IF NOT EXISTS zipkin_annotations (
  ...
  UNIQUE KEY(`trace_id_high`, `trace_id`, `span_id`, `a_key`, `a_timestamp`) COMMENT 'Ignore insert on duplicate',
  ...
  INDEX(`a_type`) COMMENT 'for getTraces',
  INDEX(`a_key`) COMMENT 'for getTraces',
